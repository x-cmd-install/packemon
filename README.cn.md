...
[![x-cmd/install — packemon Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/packemon.svg?lang=zh)](https://x-cmd.com/install/packemon)
...
合计: **12,728** 行代码（覆盖前 5 种语言、共 **118** 个文件）。
...
- **上游仓库**: <https://github.com/ddddddO/packemon>
- **许可证**: BSD-2-Clause

## 发布

- **最新版本**: `v1.8.27` (2026-09-19)
- **最近提交**: 2026-09-19
- **Release 含资产**: 12 个

## 流行度

- **Star**: 308 · **Fork**: 6 · **开放 issue**: 95 · **贡献者**: 3

## 累计统计

- **发布数**: 77 · **已合并 PR**: 145 · **开放 PR**: 3 · **已关闭 issue**: 62 · **开放 issue**: 33 · **提交数**: 759

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-26 | 1 | 5 | 2 | 0 | 1 | 14 |
| last60d | 2026-07-27 | 1 | 9 | 2 | 0 | 1 | 18 |
| 90d | 2026-06-27 | 2 | 13 | 2 | 0 | 1 | 22 |
| last180d | 2026-03-29 | 6 | 29 | 2 | 2 | 3 | 41 |
| 360d | 2025-09-30 | 11 | 59 | 3 | 2 | 5 | 74 |
| last720d | 2024-10-05 | 66 | 134 | 3 | 28 | 15 | 445 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/packemon.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260925.yml` · 2026-09-25T05:36:29Z._
